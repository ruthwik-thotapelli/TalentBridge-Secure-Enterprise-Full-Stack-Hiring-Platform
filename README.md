...
The application follows RESTful API architecture with a clear separation between frontend and backend, making it maintainable, scalable, and production-ready. It is designed to reflect real-world enterprise software development practices, including modular code structure, API testing, and version-controlled workflows.

✨ Key Features

Secure authentication and role-based access (Admin / Recruiter / Candidate)

Job posting, application tracking, and candidate management

ATS-style resume screening and scoring
...
Database: MySQL
APIs & Tools: REST APIs, JWT, Postman, Git, GitHub
